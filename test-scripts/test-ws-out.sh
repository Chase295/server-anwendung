...
# WebSocket-Out Node Tester - Start Script
# =========================================
# Dieses Script startet den Python WebSocket-Server zum Testen der WS-Out-Node
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  WebSocket-Out Node Tester (Server)${NC}"
echo -e "${BLUE}========================================${NC}\n"
...
echo -e "${GREEN}🚀 Starte WebSocket-Server...${NC}\n"
